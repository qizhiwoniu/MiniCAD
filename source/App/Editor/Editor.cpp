...
namespace YGsoftware
{
    ...
    bool Editor::IsGridShown() const
    {
        return m_showGrid;
    }

    void Editor::SetShowGrid(bool show)
    {
        if (m_showGrid == show) return;
        m_showGrid = show;
    }
    bool Editor::IsGizmoShown() const
    {
        return m_showGizmo;
    }

    void Editor::SetShowGizmo(bool show)
    {
        if (m_showGizmo == show) return;
        m_showGizmo = show;
    }
    bool Editor::IsAxisShown() const
    {
        return m_showAxis;
    }

    void Editor::SetShowAxis(bool show)
    {
        if (m_showAxis == show) return;
        m_showAxis = show;
    }
